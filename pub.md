...
2. **_Hao Luo_**, Wei Jiang, Xuan Zhang, et al. AlignedReID++: Dynamically Matching Local Information for Person Re-Identification. (Pattern Recognition)
...
3. _**Hao Luo**_, Xing Fan, Chi Zhang, Wei Jiang. STNReID: Deep Convolutional Networks with Spatial Transformer Networks for
...
4. _**Hao Luo**_, Zhengping Luo, Chao Xu, Wei Jiang. Optical plasma boundary reconstruction based onleast squares for EAST Tokamak[J]. Frontiers of Information Technology & Electronic Engineering, 2018. DOI:10.1631/FITEE.1700041
...
7. Jingjing Qian, Wei Jiang, _**Hao Luo**_*, Hongyan Yu. Stripe-based and Attribute-aware Network: A Two-Branch Deep Model for Vehicle Re-identification. Measurement Science and Technology.

     [[pdf]](https://arxiv.org/abs/1910.05549)
     
8. Jianyang Gu, Wei Jiang, _**Hao Luo**_*, et al. An efficient global representation constrained by Angular Triplet loss for vehicle re-identification. Pattern Analysis and Applications, 2020: 1-13.

    [[pdf]](https://link.springer.com/article/10.1007/s10044-020-00900-w)
    
9. Zaiqiang Wu, Wei Jiang,  _**Hao Luo**_, Lin Cheng. A Novel Self-intersection Penalty Term for Statistical Body Shape Models and Its Applications in 3D Pose Estimation. (Applied Science, 2019. DOI:10.3390/app9030400)
